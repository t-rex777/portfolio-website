        ...
        <div className="flex flex-col justify-center items-center mt-8 sm:flex-row">
          ...
          <div className="sm:w-1/2 " ref={setRef}>
            <p className="aboutStyle ">
              ...
              <span className="font-bold">
                HTML, CSS, Javascript, React, Typescript, Bootstrap, Tailwind
                CSS, Redux toolkit.{" "}
              </span>
              I also love to collaborate with other folks on amazing projects.
              Currently, I am learning more about NextJS and Vue. Besides being
              a developer, I am a gamer and a fitness enthusiastic too.
            </p>
          ...
          <div className="flex justify-center ">
            <a
              ...
              target="_blank"
            >
              <button className=" border-4 mt-5 sm:mt-0 text-md w-max border-purple-600 px-4 py-2 text-purple-600  hover:bg-purple-900  hover:text-white sm:text-xl font-bold md:text-2xl" ref={setRef}>
                Resume
              </button>
            </a>{" "}
          </div>
